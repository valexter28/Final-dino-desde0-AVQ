...
class Cactus:
    ...
    def set_texture(self):
        path = os.path.join('assets/images/cactus0.png')
        self.texture = pygame.image.load(path)
        self.texture = pygame.transform.scale(self.texture, (self.width, self.height))
...
class LargeCactus:
    ...
    def set_texture(self):
        path = os.path.join('assets/images/cactus1.png')
        self.texture = pygame.image.load(path)
        self.texture = pygame.transform.scale(self.texture, (self.width, self.height))
...
class BBird:
    ...
    def set_texture(self):
        path = os.path.join('assets/images/Bird2.png')
        self.texture = pygame.image.load(path)
        self.texture = pygame.transform.scale(self.texture, (self.width, self.height))
...
class Game:
    ...
    def spawn_cactus(self):
        ...
        if len(self.obstacles) > 0:
            prev_largecactus = self.obstacles[-1]
            x = random.randint(prev_largecactus.x + self.dino.width + 84, WIDTH + prev_largecactus.x + self.dino.width + 84)

        else:
            x = random.randint(WIDTH + 100, 1000)
        
        largecactus = LargeCactus(x)
    ...
    def spawn_bird(self):
        ...
        if len(self.obstacles) > 0:
            prev_bird = self.obstacles[-1]
            x = random.randint(prev_bird.x + self.dino.width + 84, WIDTH + prev_bird.x + self.dino.width + 84)
        ...
        if len(self.obstacles) > 0:
            prev_bbird = self.obstacles[-1]
            x = random.randint(prev_bbird.x + self.dino.width + 84, WIDTH + prev_bbird.x + self.dino.width + 84)
